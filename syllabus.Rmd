...
This class will use the R programming language and the R Studio Integrated Development Environment (IDE). There are several ways to use R and R Studio. However, we will use the R Studio Cloud service, an online R Studio environment for easy access and usage.
