...
The computation of a student's final grade is based on the following:
  ...
  * To get a minimum passing grade (C) for the course, you need at least \%80 *Acceptable* grades of mini-assignments, \%60 *Acceptable* grades of lab assignments, and an *Acceptable* grade for the final project.
