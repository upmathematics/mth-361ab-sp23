...
\end{aligned}$$
    ...
    d. Measure the uncertainty of the point estimate and measure the uncertainty of the null value.
    e. Compare the values computed in (d) and (e). Are there any significant differences in these values? Explain your reasoning.
    f. Compute the Z-score of the point estimate under the assumption that the null hypthesis is true. Should you be surprised by the data?
