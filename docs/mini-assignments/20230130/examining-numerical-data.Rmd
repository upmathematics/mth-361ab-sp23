...
subtitle: "Mini-Assignment 2023-01-30 - MTH 361 A/B - Spring 2023"
header-includes: |
  \usepackage{fancyhdr}
  \pagestyle{fancy}
  \fancyhead[RO,R]{MTH 361 A/B - Spring 2023}
  \fancyfoot[CO,C]{}
  \fancyfoot[R]{\thepage}
  \usepackage{float}
output:
...
## I. Exploring Numerical Data Part A
...
3. (Outstanding Question) **Education Level.** Consider the number of observations per education level shown in Fig. \@ref(fig:education-level-observations), the summary statistics shown in Fig. \@ref(fig:education-level-summary), and the histograms and boxplots shown in Fig. \@ref(fig:education-level-distributions). 
