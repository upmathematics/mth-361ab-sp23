---
title: "Orientation and Introduction <br><br> MATH 361: Applied Statistics I <br> Spring 2023"
...
knitr::include_graphics("1-files/560-5602283_bunco-clipart.png")
```
...
# Motivating Example 1 {.smaller}

### Vaccine Efficacy vs Vaccine Effectiveness

<div class='left' style='float:left;width:49%'>
```{r vox-vaccine-efficacy, echo=FALSE, fig.cap="Image: Vaccine Efficacy Rates. [1]", out.width="400px", fig.align="center"}
knitr::include_graphics("1-files/vox-vaccine-efficacy-visualization.png")
```
<center>
...
```{r unqover-example-questions, echo=FALSE, fig.cap="", out.width="700px", fig.align="center"}
knitr::include_graphics("1-files/unqover-example-questions.png")
```
```{r unqover-example-answers, echo=FALSE, fig.cap="", out.width="700px", fig.align="center"}
knitr::include_graphics("1-files/unqover-example-answers.png")
```
</center>
